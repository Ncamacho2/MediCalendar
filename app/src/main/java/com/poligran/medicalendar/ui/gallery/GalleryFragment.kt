...
class GalleryFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val listaImagenes = listOf(
            ...
            ImagenItem(R.drawable.sede_1, "$NombreSede Sede Fontibón $direccion Avenida Boyacá # 72-10, Fontibón $contact Andrés Gómez"),
            ImagenItem(R.drawable.sede_2, "$NombreSede Sede Teusaquillo $direccion Calle 72 # 12-30, Teusaquillo $contact Ana López"),
            ImagenItem(R.drawable.sede_3, "$NombreSede Sede Chico $direccion Carrera 9 # 65-15, Chico $contact Andrés Gómez") ,
            ImagenItem(R.drawable.sede_1, "$NombreSede Sede Cedritos $direccion Calle 127 # 45-80, Cedritos $contact Ana López"),
            ImagenItem(R.drawable.sede_2, "$NombreSede Sede La Candelaria $direccion Avenida Caracas # 36-20, La Candelaria $contact Laura García"),
            ImagenItem(R.drawable.sede_3, "$NombreSede Sede El Chicó $direccion Calle 100 # 19-30, El Chicó $contact Juan Martínez")
        )
